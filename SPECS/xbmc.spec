...
# Overwrite the standard macro - disable java and python bytecode creation 
...
# Fix hybris error compilation (mescanef)
Patch7: xbmc-13.1-hybris.patch
...
%changelog
* Sun Jul 13 2014 mescanef <zone@mescanef.net> - 13.1.odroidu
- Rebuild using mdrjr sources for exynos, ARM based, boards (odroidu's)
